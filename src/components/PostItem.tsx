...
function PostItem() {
  ...
  return (
    <div className="relative group/post w-[350px] flex flex-col gap-3 p-3 border border-gray-200 rounded-xl overflow-hidden hover:border-2 hover:border-blue-600 ">
      <div className="flex justify-between">
        <div className="flex gap-2">
          ...
          <div className="flex flex-col  ">
            ...
            <h4 className="text-[12px] text-gray-400">12 Avril</h4>
          </div>
        </div>
      ...
      <div className="font-medium text-xl ">
        Cillum ullamco sit consectetur qui exercitation ullamco est consectetur
        incididunt.
      </div>
      <div
        className={classNames(
      ...
      >
        <div className=" relative w-full h-[180px] flex justify-center items-center px-3 rounded-t-2xl rounded-b-[10px] bg-blue-600">
          ...
          <Link
            to=""
            className="  w-full rounded-md bg-white py-2 text-center text-xl font-bold text-gray-900 shadow-md"
          >
            Voir le post
          </Link>
        </div>
